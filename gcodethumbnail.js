...
/** remove node.js ~cat.alucardo@gmail.com
"use strict";
...
// I like map ~cat.alucardo@gmail.com
	gcode.lines.map(function(e){
		if(e.type === "G0" && colors.G0 !== undefined) {
            drawStraightLine(ctx, ratio, start, e, cH, colors.G0);
        } else if(e.type === "G1" && colors.G1 !== undefined) {
            drawStraightLine(ctx, ratio, start, e, cH, colors.G1);
        } else if((e.type === "G2" ||
                    e.type === "G3") && colors.G2G3 !== undefined)
        {
            drawCurvedLine(ctx, ratio, start, e, cH, colors.G2G3);
        }
	})
...
function getCanvas(gcodeStr, colors, width, height) {
	//remove node.js ~cat.alcuardo@gmail.com
...
//remove node.js ~cat.alcuardo@gmail.com
function getBase64(gcodeStr, colors, width, height) {
    var canvas = getCanvas(gcodeStr, colors, width, height);
    return canvas.toDataURL("img/png");
};
function getBase64Jpeg80(gcodeStr, colors, width, height) {
    var canvas = getCanvas(gcodeStr, colors, width, height);
    return canvas.toDataURL("img/jpeg",80);
};
//remove node.js ~cat.alcuardo@gmail.com
/**
